<?php
  ...
  $consulta_pueblos = 'SELECT count(id_pueblo) AS pueblo_magico FROM pueblo';
  ...
  $query4 = mysqli_query($conexion,$consulta_platillo);
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            <div class="col-md-3 col-sm-3 col-xs-3 tile_stats_count">
              <center>
                <span class="count_top"><i class="fa fa-user"></i> Total de Estados</span>
                <div class="count"><?php echo $data3["estado"]; ?></div>
              </center>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-3 tile_stats_count">
              <center>
                <span class="count_top"><i class="fa fa-user"></i> Total de Pueblos Mágicos</span>
                <div class="count"><?php echo $data["pueblo_magico"]; ?></div>
              </center>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-3 tile_stats_count">
              <center>
                <span class="count_top"><i class="fa fa-user"></i> Total de Platillos</span>
                <div class="count"><?php echo $data4["platillo"]; ?></div>
              </center>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-3 tile_stats_count">
              <center>
                <span class="count_top"><i class="fa fa-user"></i> Total de Artesanias</span>
                <div class="count"><?php echo $data2['artesania']; ?></div>
              </center>
            </div>
          </div>
          <!-- /top tiles -->
